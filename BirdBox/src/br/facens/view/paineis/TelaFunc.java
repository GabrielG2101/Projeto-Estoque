...
public class TelaFunc extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        PainelLoginFunc = new javax.swing.JPanel();
        ...
        PainelLoginFunc.setBackground(new java.awt.Color(239, 239, 239));
        PainelLoginFunc.setForeground(new java.awt.Color(255, 255, 255));
        PainelLoginFunc.setPreferredSize(new java.awt.Dimension(754, 471));
        PainelLoginFunc.setLayout(null);
        ...
        logodireita.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/FuncImg.png"))); // NOI18N
        ...
        BotaoEntrarLayout.setHorizontalGroup(
            ...
            .addGroup(BotaoEntrarLayout.createSequentialGroup()
                .addGap(25, 25, 25)
                .addComponent(BotaoEntrartxt, javax.swing.GroupLayout.PREFERRED_SIZE, 122, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(26, Short.MAX_VALUE))
        );
        BotaoEntrarLayout.setVerticalGroup(
            BotaoEntrarLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(BotaoEntrartxt, javax.swing.GroupLayout.DEFAULT_SIZE, 50, Short.MAX_VALUE)
        );
        ...
        PainelLoginFunc.add(bg);
        bg.setBounds(6, 0, 754, 471);
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(PainelLoginFunc, javax.swing.GroupLayout.DEFAULT_SIZE, 742, Short.MAX_VALUE)
                .addContainerGap())
        );
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(PainelLoginFunc, javax.swing.GroupLayout.DEFAULT_SIZE, 459, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    private void BotaoEntrarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_BotaoEntrarMouseClicked
        try {
            ...
            FuncionariosController LoginFunc = new FuncionariosController();
            if (LoginFunc.verificalogin(email, senha) == true) {

                PainelLoginFunc.removeAll();
                PainelLoginFunc.repaint();
                PainelLoginFunc.revalidate();
                RequisicaoFuncionario alteracoes = new RequisicaoFuncionario(senha);
                alteracoes.setSize(760, 471);
                PainelLoginFunc.add(alteracoes);
                PainelLoginFunc.repaint();
                PainelLoginFunc.revalidate();
            } else {
    ...
    private javax.swing.JPanel PainelLoginFunc;
