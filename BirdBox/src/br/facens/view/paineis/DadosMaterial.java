...
public class DadosMaterial extends javax.swing.JPanel {

    public DadosMaterial() {
        initComponents();
        try {
       ...
       TableActionEvent event = new TableActionEvent() {
            ...
            public void onEdit(int row) {
                ...
                Materiais a = new Materiais();
                a.setCodigo((int) TabelaMateriais.getValueAt(TabelaMateriais.getSelectedRow(), 0));
                a.setNome((String) TabelaMateriais.getValueAt(TabelaMateriais.getSelectedRow(), 1));
                a.setDescricao((String) TabelaMateriais.getValueAt(TabelaMateriais.getSelectedRow(), 2));
                a.setValor((double) TabelaMateriais.getValueAt(TabelaMateriais.getSelectedRow(), 3));
                a.setQuantidade((int) TabelaMateriais.getValueAt(TabelaMateriais.getSelectedRow(), 4));
                AlterarDadosMateriais alterar = new AlterarDadosMateriais(a);
            ...
            public void onDelete(int row) {
                ...
                int resultado = JOptionPane.showConfirmDialog(null, "Deseja excluir o Material?", "Excluir Material", 0);
                if (resultado == JOptionPane.YES_OPTION) {
                    row = TabelaMateriais.getSelectedRow();

                    try {
                        DefaultTableModel tableModel = (DefaultTableModel) TabelaMateriais.getModel();
                        MateriaisController materiaisController = new MateriaisController();
                        int codigo = (int) tableModel.getValueAt(row, 0);
                        materiaisController.delete(codigo);

                        JOptionPane.showMessageDialog(null, "Material Removido");
        ...
        TabelaMateriais.getColumnModel().getColumn(5).setCellRenderer(new TableActionCellRender());
        TabelaMateriais.getColumnModel().getColumn(5).setCellEditor(new TableActionCellEditor(event));
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Dados de Materiais");
        ...
        BotaoVoltar.setBounds(6, 10, 56, 26);
        ...
        TabelaMateriais.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "Nome", "Descrição", "Valor", "Quantidade", "Action"
            }
        ) {
        ...
        if (TabelaMateriais.getColumnModel().getColumnCount() > 0) {
            TabelaMateriais.getColumnModel().getColumn(0).setPreferredWidth(40);
            TabelaMateriais.getColumnModel().getColumn(2).setResizable(false);
            TabelaMateriais.getColumnModel().getColumn(2).setPreferredWidth(100);
            TabelaMateriais.getColumnModel().getColumn(3).setPreferredWidth(25);
            TabelaMateriais.getColumnModel().getColumn(4).setResizable(false);
            TabelaMateriais.getColumnModel().getColumn(4).setPreferredWidth(20);
            TabelaMateriais.getColumnModel().getColumn(5).setPreferredWidth(50);
        }

        PainelDados.add(jScrollPane1);
        jScrollPane1.setBounds(6, 131, 710, 270);

        add.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        add.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/novo_material.png"))); // NOI18N
        ...
        add(PainelDados);
        PainelDados.setBounds(6, 6, 732, 456);
    ...
    private void addMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_addMouseClicked
        ...
        PainelDados.repaint();
        PainelDados.revalidate();
        CadastrarNovoMaterial cadastrar = new CadastrarNovoMaterial();
