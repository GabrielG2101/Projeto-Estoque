...
public class PainelAction_r extends javax.swing.JPanel {

    
    public PainelAction_r() {
        initComponents();
    }
public void initEvent(TableActionEvent event, int row) {
    ...
    private void initComponents() {
        ...
        cmdAlterar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/certo.png"))); // NOI18N
